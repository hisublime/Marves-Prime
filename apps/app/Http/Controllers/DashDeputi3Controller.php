...
class DashDeputi3Controller extends Controller
{
    public function index(Request $request)
    {
        // $dashboard = \App\Models\Dashboard::getTable('dashboard');
        $asdep = ProgramKerja::select('eselon2')->whereIn('eselon1', ['Deputi 3'])->groupBy('eselon2')->get();
        ...
        //Total Done
        $Deputi3Done = DB::table('program_kerja')
                        ->where('eselon1', 'Deputi 3')
                        ->where('status', 'Done')
                        ->count();
        
        //Total Pending
        $Deputi3Pend = DB::table('program_kerja')
                        ->where('eselon1', 'Deputi 3')
                        ->where('status', 'Pending')
                        ->count();

        //Total Suspended
        $Deputi3Sus = DB::table('program_kerja')
                        ->where('eselon1', 'Deputi 3')
                        ->where('status', 'Suspended')
                        ->count();

        //Total Overdue
        $Deputi3Over = DB::table('program_kerja')
                        ->where('eselon1', 'Deputi 3')
                        ->where('status', 'Overdue')
                        ->count();
        ...
        return view('dashboard/deputi3', ['categories' => $categories], compact('asdep1Act', 'asdep2Act', 'asdep3Act', 'asdep4Act', 'asdep5Act', 'SekdepAct', 'asdep1Done', 'asdep2Done', 'asdep3Done', 'asdep4Done', 'asdep5Done', 'SekdepDone',
        ...
        'Deputi3Total', 'Deputi3Act', 'Deputi3Done', 'Deputi3Pend', 'Deputi3Sus', 'Deputi3Over'));
    }

    public function dep3(Request $request)
    {
        // $dashboard = \App\Models\Dashboard::getTable('dashboard');
        $asdep = ProgramKerja::select('eselon2')->whereIn('eselon1', ['Deputi 3'])->groupBy('eselon2')->get();
        ...
        return view('menko/deputi3', ['categories' => $categories], compact('asdep1Act', 'asdep2Act', 'asdep3Act', 'asdep4Act', 'asdep5Act', 'SekdepAct', 'asdep1Done', 'asdep2Done', 'asdep3Done', 'asdep4Done', 'asdep5Done', 'SekdepDone',
        'asdep1Pend', 'asdep2Pend', 'asdep3Pend', 'asdep4Pend', 'asdep5Pend', 'SekdepPend', 'asdep1Sus', 'asdep2Sus', 'asdep3Sus', 'asdep4Sus', 'asdep5Sus', 'SekdepSus', 'asdep1Over', 'asdep2Over', 'asdep3Over', 'asdep4Over', 'asdep5Over', 'SekdepOver',
        'Deputi3Total', 'Deputi3Act', 'Deputi3Done', 'Deputi3Pend', 'Deputi3Sus', 'Deputi3Over'));
    }
}
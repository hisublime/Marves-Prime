...
class DashDeputi6Controller extends Controller
{
    public function index(Request $request)
    {
        // $dashboard = \App\Models\Dashboard::getTable('dashboard');
        $asdep = ProgramKerja::select('eselon2')->whereIn('eselon1', ['Deputi 6'])->groupBy('eselon2')->get();
        ...
        //Total Done
        $Deputi6Done = DB::table('program_kerja')
                        ->where('eselon1', 'Deputi 6')
                        ->where('status', 'Done')
                        ->count();
        
        //Total Pending
        $Deputi6Pend = DB::table('program_kerja')
                        ->where('eselon1', 'Deputi 6')
                        ->where('status', 'Pending')
                        ->count();

        //Total Suspended
        $Deputi6Sus = DB::table('program_kerja')
                        ->where('eselon1', 'Deputi 6')
                        ->where('status', 'Suspended')
                        ->count();

        //Total Overdue
        $Deputi6Over = DB::table('program_kerja')
                        ->where('eselon1', 'Deputi 6')
                        ->where('status', 'Overdue')
                        ->count();
        ...
        return view('dashboard/deputi6', ['categories' => $categories], compact('asdep1Act', 'asdep2Act', 'asdep3Act', 'asdep4Act', 'asdep5Act', 'SekdepAct', 'asdep1Done', 'asdep2Done', 'asdep3Done', 'asdep4Done', 'asdep5Done', 'SekdepDone',
        ...
        'Deputi6Total', 'Deputi6Act', 'Deputi6Done', 'Deputi6Pend', 'Deputi6Sus', 'Deputi6Over'));
    }

    public function dep6(Request $request)
    {
        // $dashboard = \App\Models\Dashboard::getTable('dashboard');
        $asdep = ProgramKerja::select('eselon2')->whereIn('eselon1', ['Deputi 6'])->groupBy('eselon2')->get();
        ...
        return view('menko/deputi6', ['categories' => $categories], compact('asdep1Act', 'asdep2Act', 'asdep3Act', 'asdep4Act', 'asdep5Act', 'SekdepAct', 'asdep1Done', 'asdep2Done', 'asdep3Done', 'asdep4Done', 'asdep5Done', 'SekdepDone',
        'asdep1Pend', 'asdep2Pend', 'asdep3Pend', 'asdep4Pend', 'asdep5Pend', 'SekdepPend', 'asdep1Sus', 'asdep2Sus', 'asdep3Sus', 'asdep4Sus', 'asdep5Sus', 'SekdepSus', 'asdep1Over', 'asdep2Over', 'asdep3Over', 'asdep4Over', 'asdep5Over', 'SekdepOver',
        'Deputi6Total', 'Deputi6Act', 'Deputi6Done', 'Deputi6Pend', 'Deputi6Sus', 'Deputi6Over'));
    }
}

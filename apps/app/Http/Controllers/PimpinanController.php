...
class PimpinanController extends Controller
{
    ...
    public function deputi1program(){
        ...
        return view ('pimpinan.program-isu',['data_program'=>$data_program, 'deputi1Done' => $deputi1Done, 'persen' => $persen, 'Deputi1Total' => $Deputi1Total]);
    }
    ...
    public function deputi2program(){
        ...
        return view ('pimpinan.program-isu',['data_program'=>$data_program, 'deputi2Done' => $deputi2Done, 'persen' => $persen, 'Deputi2Total' => $Deputi2Total]);
    }
    ...
    public function deputi3program(){
        ...
        return view ('pimpinan.program-isu',['data_program'=>$data_program, 'deputi3Done' => $deputi3Done, 'persen' => $persen, 'Deputi3Total' => $Deputi3Total]);
    }
    ...
    public function deputi4program(){
        ...
        return view ('pimpinan.program-isu',['data_program'=>$data_program, 'deputi4Done' => $deputi4Done, 'persen' => $persen, 'Deputi4Total' => $Deputi4Total]);
    }
    ...
    public function deputi5program(){
        ...
        return view ('pimpinan.program-isu',['data_program'=>$data_program, 'deputi5Done' => $deputi5Done, 'persen' => $persen, 'Deputi5Total' => $Deputi5Total]);
    }
    ...
    public function deputi6program(){
        ...
        return view ('pimpinan.program-isu',['data_program'=>$data_program, 'deputi6Done' => $deputi6Done, 'persen' => $persen, 'Deputi6Total' => $Deputi6Total]);
    }
	...
	public function sekretariatprogram(){
        ...
        return view ('pimpinan.program-isu',['data_program'=>$data_program, 'sekretariatDone' => $sekretariatDone, 'persen' => $persen, 'sekretariatTotal' => $sekretariatTotal]);
    }
}
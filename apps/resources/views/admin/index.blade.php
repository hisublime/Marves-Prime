  ...
  <body>
    <div class="container-fluid mt-3">
        <div class="container-content">
            <div class="col-10">
                <a href="{{ url('/popup-program') }}"><button id="myBtn" class="btn btn-primary btn-sm mt-0" >Tambah Program/Isu</button></a>  
            </div>
        ...
        <div class="table-responsive-sm">
          <table class="table table-striped" style="width:100%" id="datatableid">
            ...
            @foreach($data_program as $program)
              <tr>
                <td><a href="/detail-program-isu/{{$program->id_proker}}" class="href" style="color: #000000; text-decoration: none;">{{$program->nama_proker}}</td></a>
                @if($program->status == 'Done')
                <td><img class="gambar ms-2" src="/images/done.png" alt="" /> <label class="status">Done</label></td>
                @elseif($program->status == 'Overdue')

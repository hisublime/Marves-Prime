...
<div class="panel">
  <div class="panel-heading">
    ...
    <div class ="topnav">
      ...
      <a href="/notifikasi/draft-risalah"  class="active">Draft Risalah</a>
    </div>
    <br>
    <div class="left">
...
<!--  <i class="lnr lnr-plus-circle"> -->
  ...
  <div class="panel-body">
    <table id="datatableid" class="table table-striped">
      ...
      <tr>
        <th class="kepalajudul">Judul Rapat Koordinasi</th>
        <th class="kepalajudul">Tanggal</th>
        <th class="kepalajudul">Aksi</th>
      </tr>
      </thead>
      <tbody>
      ...
      <td>
        ...
        onclick="window.location.href='/notifikasi/detail-draft-risalah/{{ $rakor->id_kegiatan }}'"

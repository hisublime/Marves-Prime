...
<div class="panel">
  <div class="panel-heading">
    ...
    <div class ="topnav">
      ...
      <a href="/persidangan/request-persidangan"  class="">Request</a>
      <a href="/persidangan/ditolak-persidangan"  class="active">Ditolak</a>
            ...
            <div class="modal-body ms-4">
              ...
              {{-- <div class="d-flex justify-content-md-end">
                <div class="d-grid col-2 ms-5 jus">                        
                    ...
                    type="submit" onclick="window.location.href='persidangan/tambah-draft-risalah/{{ $rakor->id_rakor }}'">
                    Approve
                  </button>
                  </div>
                </div> --}}

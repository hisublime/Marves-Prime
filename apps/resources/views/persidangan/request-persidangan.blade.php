...
@section('title', 'Daftar Rapat Koordinasi')
...
<div class="panel">
  <div class="panel-heading">
    ...
    {{-- <div class="d-grid col-2">
      <button  class="btn btn-primary btn-lg lh-lg fs-4" type="submit"  onclick="window.location.href='persidangan/tambah-draft-risalah'">
        Tambah Draft Risalah
      </button>
    </div> --}}
    <h1 class="text-title">Daftar Rapat Koordinasi</h1>

    <div class ="topnav">
      <a href="/persidangan"  class="">Selesai</a>
      <a href="#"  class="active">Request</a>
      <a href="/persidangan/ditolak-persidangan"  class="">Ditolak</a>
...
<!--  <i class="lnr lnr-plus-circle"> -->
  ...
  <div class="panel-body">
    <table id="datatableid" class="table table-striped">
      <thead style="background-color: #DBE1FF">
      <tr>
      ...
      <tr>
      <td>{{$rakor->topik}}</td>
      <td>{{ \Carbon\Carbon::parse($rakor->waktu)->format('H:i') }} WIB,{{ \Carbon\Carbon::parse($rakor->tgl_pelaksanaan)->format('d M Y') }}</td>
      <td>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body ms-4">
              ...
              <div class="d-flex justify-content-md-end">
                <div class="d-grid col-2 ms-5 mb-3 jus">                        
                    <button
                    class="btn btn-primary btn-lg lh-lg fs-4"
                    type="submit" onclick="window.location.href='/persidangan/approve/{{ $rakor->id_rakor }}'">
                    Approve
                  </button>
                  </div>
                </div>
              <div class="d-flex justify-content-md-end">
                <div class="d-grid col-2 ms-5 jus">                        
                    <button
                    class="btn btn-danger btn-lg lh-lg fs-4"
                    type="submit" onclick="window.location.href='/persidangan/reject/{{ $rakor->id_rakor }}'">
                    Reject
                  </button>
                  </div>
                </div>

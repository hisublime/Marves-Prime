...
<h1 style="text-align: center; "> Deputi Bidang Koordinasi Sumber Daya Maritim </h1>
...
Highcharts.chart('chartEselon', {
    ...
    title: {
        text: 'Deputi Sumber Daya Maritim'
    },
    xAxis: {

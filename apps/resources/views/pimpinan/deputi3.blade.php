...
<h1 style="text-align: center; "> Deputi Bidang Koordinasi Infrastruktur dan Transportasi </h1>
...
Highcharts.chart('chartEselon', {
    ...
    title: {
        text: 'Deputi Infrastruktur dan Transportasi'
    },
    xAxis: {

...
@section('title', 'Daftar Program/Isu')
        ...
        <div class="col-md-4">
          <div class="dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
              <li><a class="dropdown-item" href="/program-isu">Choose</a></li>
              <li><a class="dropdown-item" href="/pimpinan/deputi1program">Deputi 1</a></li>
              <li><a class="dropdown-item" href="/pimpinan/deputi2program">Deputi 2</a></li>
              <li><a class="dropdown-item" href="/pimpinan/deputi3program">Deputi 3</a></li>
              <li><a class="dropdown-item" href="/pimpinan/deputi4program">Deputi 4</a></li>
              <li><a class="dropdown-item" href="/pimpinan/deputi5program">Deputi 5</a></li>
              <li><a class="dropdown-item" href="/pimpinan/deputi6program">Deputi 6</a></li>
              <li><a class="dropdown-item" href="/pimpinan/sekretariatprogram">Sekretariat Kemenko</a></li>
            </ul>
          </div>
        </div>
      </div>     
        ...
        <div class="table-responsive-sm">
          <table class="table table-striped" style="width:100%" id="datatableid">
            ...
            @foreach($data_program as $req)
              <tr>
                <td><a href="/detail-program-isu/{{$req->id_proker}}" class="href" style="color: #000000; text-decoration: none;">{{$req->nama_proker}}</td></a>
                @if($req->status == 'Done')

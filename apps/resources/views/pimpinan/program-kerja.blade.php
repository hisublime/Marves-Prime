        ...
        <div class="d-flex row m-5 ">
          <div class="row justify-content-md-center">
            <div class="col-sm-4 mb-4"> <div class="card ">
                ...
                <a href="{{ url('/sekretariat-kemenko') }}"><img src="{{asset('images/sekertariat.png')}}" class="rounded float-start" alt="..."></a>
            ...
            <div class="col-sm-4 mb-4">
              <div class="card ">
                <div class="card-body d-flex justify-content-start align-items-center overflow-hidden">
                  <a href="{{ url('/inspektorat') }}"><img src="{{asset('images/inspektorat.png')}}" class="rounded float-start" alt="..."></a>
            ...
            <div class="col-sm-4 mb-4">
              <div class="card ">
                <div class="card-body d-flex justify-content-start align-items-center overflow-hidden">
                  <a href="{{ url('/deputi1') }}"><img src="{{asset('images/kedaulatan.png')}}" class="rounded float-start" alt="..."></a>
            ...
            <div class="col-sm-4 mb-4">
              <div class="card ">
                <div class="card-body d-flex justify-content-start align-items-center overflow-hidden">
                  <a href="{{ url('/deputi2') }}"><img src="{{asset('images/sumber-daya.png')}}" class="rounded float-start" alt="..."></a>
            ...
            <div class="col-sm-4 mb-4">
              <div class="card ">
                <div class="card-body d-flex justify-content-start align-items-center overflow-hidden">
                  <a href="{{ url('/deputi3') }}"><img src="{{asset('images/infrastruktur-transportasi.png')}}" class="rounded float-start" alt="..."></a>
            ...
            <div class="col-sm-4 mb-4">
              <div class="card ">
                <div class="card-body d-flex justify-content-start align-items-center overflow-hidden">
                  <a href="{{ url('/deputi4') }}"><img src="{{asset('images/pengelolaan-lingkungan.png')}}" class="rounded float-start" alt="..."></a>
            ...
            <div class="col-sm-4 mb-4">
              <div class="card ">
                <div class="card-body d-flex justify-content-start align-items-center overflow-hidden">
                  <a href="{{ url('/deputi5') }}"><img src="{{asset('images/pariwisata-ekonomi.png')}}" class="rounded float-start" alt="..."></a>
            ...
            <div class="col-sm-4 mb-4">
              <div class="card ">
                <div class="card-body d-flex justify-content-start align-items-center overflow-hidden">
                  <a href="{{ url('/deputi6') }}"><img src="{{asset('images/investasi-pertambangan.png')}}" class="rounded float-start" alt="..."></a>
